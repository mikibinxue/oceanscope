...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonSwimmerController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (!m_Jump)
            {
                m_Jump = CrossPlatformInputManager.GetButton("Jump"); //uncomment
            }
        ...
        {
            // read inputs
            float h = CrossPlatformInputManager.GetAxis("Horizontal"); //uncomment
            float v = CrossPlatformInputManager.GetAxis("Vertical"); //uncomment
